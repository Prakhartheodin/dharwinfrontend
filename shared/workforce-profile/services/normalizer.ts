...
export function normalize(state: WorkforceFormState): NormalizedWorkforce {
  ...
  return {
    ...
    eadCardNumber: trimString(pi.eadCardNumber),
    eadValidFrom: trimString(pi.eadValidFrom),
    eadValidTo: trimString(pi.eadValidTo),
    visaNumber: trimString(pi.visaNumber),
    visaIssueDate: trimString(pi.visaIssueDate),
    visaExpiryDate: trimString(pi.visaExpiryDate),
