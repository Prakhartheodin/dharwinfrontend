...
export const ACTIVITY_LOG_ACTIONS: string[] = [
  ...
  "employee.payrollDetails.request",
  "employee.payrollDetails.submit",
  "employee.payrollDetails.verify",
  "employee.payrollDetails.reject",
  "employee.payrollDetails.cancel",
  "employee.payrollDetails.reveal",
...
export const ACTION_LABELS: Record<string, ActivityLogLabel> = {
  ...
  "jobApplication.moveToOffer": { title: "Moved to Offer", description: "An application was advanced from Interview to Offer." },
  ...
  "offer.interviewBypass": {
    title: "Offer without interview",
    description: "An offer was created with no interview round marked selected.",
  },
  ...
  "employee.payrollDetails.request": { title: "Payroll details requested", description: "Bank and payroll details were requested from a candidate or employee." },
  "employee.payrollDetails.submit": { title: "Payroll details submitted", description: "Bank and payroll details were submitted." },
  "employee.payrollDetails.verify": { title: "Payroll details verified", description: "Submitted payroll details were approved." },
  "employee.payrollDetails.reject": { title: "Payroll details rejected", description: "Submitted payroll details were sent back for correction." },
  "employee.payrollDetails.cancel": { title: "Payroll details request cancelled", description: "An outstanding request for bank details was withdrawn before anything was submitted." },
  "employee.payrollDetails.reveal": { title: "Account number revealed", description: "A full bank account number was decrypted and displayed." },
