...
/**
 * Returns true if the user should see only the Attendance item in the sidebar (candidate/student portal view).
 * When true, sidebar shows only "Attendance" and hides Dashboard, Courses, ATS, etc.
 */
