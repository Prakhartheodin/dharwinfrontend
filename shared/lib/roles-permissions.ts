...
export const PERMISSION_SECTIONS: {
  ...
  },
  {
    ...
    features: [
      ...
      { id: "payroll-details", label: "Payroll & bank details" },
  ...
  },
  {
    ...
    features: [
      ...
      { id: "call-transcripts", label: "Call Transcripts" },
      { id: "call-ai", label: "Call AI Features" },
  ...
  },
  {
    id: "ai",
    label: "AI",
    features: [{ id: "chatbot", label: "Chatbot Access" }],
  },
];
