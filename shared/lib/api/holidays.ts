...
export async function getAllHolidays(params?: ListHolidaysParams): Promise<{ data: ListHolidaysResponse["data"] | Holiday[] }> {
  ...
  return response.data as { data: ListHolidaysResponse["data"] | Holiday[] };
}
