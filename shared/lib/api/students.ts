...
export interface Student {
  ...
  status: string;
  weekOff?: string[];
  /** Assigned holiday IDs (from Holiday model) */
  holidays?: string[];
  /** Assigned shift ID or populated shift object (name, timezone, startTime, endTime, etc.) */
  shift?: string | { id?: string; _id?: string; name?: string; description?: string; timezone?: string; startTime?: string; endTime?: string; isActive?: boolean } | null;
  createdAt: string;
  updatedAt: string;
}
