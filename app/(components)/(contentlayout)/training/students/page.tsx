      ...
      },
      {
        ...
        Cell: ({ row }: any) => (
          <div className="flex items-center gap-2">
            ...
            <div className="hs-tooltip ti-main-tooltip">
              <Link
                href={`/training/attendance/student/${encodeURIComponent(row.original.id)}`}
                className="hs-tooltip-toggle ti-btn ti-btn-icon ti-btn-sm bg-purple-500/10 text-purple-500 hover:bg-purple-500 hover:text-white border-purple-500/20"
          ...
          <div className="ti-modal-content">
            ...
            <div className="ti-modal-footer">
              ...
              {viewStudent && (
                <>
                  <Link
                    href={`/training/attendance/student/${encodeURIComponent(viewStudent.id)}`}
                    className="ti-btn bg-purple-500/10 text-purple-500 hover:bg-purple-500 hover:text-white border border-purple-500/20"
                  >
