            ...
            <div className="relative shrink-0 overflow-hidden">
              ...
              <div className="relative px-6 pb-5 pt-5">
                ...
                <button
                  ...
                  onClick={onClose}
                  aria-label="Close"
                  className="absolute right-4 top-4 flex h-8 w-8 items-center justify-center rounded-full bg-black/[0.06] text-gray-500 transition-all hover:bg-black/10 hover:text-gray-800 dark:bg-white/[0.06] dark:text-white/50 dark:hover:bg-white/15 dark:hover:text-white"
                >
                        ...
                        <button
                          ...
                          className={`inline-flex h-7 w-7 shrink-0 items-center justify-center rounded-lg text-sm transition-all active:scale-95 ${
                            savedContactIds.has(c.apolloId)
                              ...
                              : "bg-gray-100 text-gray-400 hover:bg-primary/10 hover:text-primary dark:bg-white/10 dark:text-white/70 dark:hover:bg-primary/15 dark:hover:text-primary"
                          }`}
                        >
