...
export default function AssignAgentSopModal({
  ...
  return createPortal(
    ...
    >
      <div
        className="relative max-h-[min(32rem,85vh)] w-full max-w-lg overflow-hidden rounded-xl border border-defaultborder/80 bg-white shadow-xl dark:border-defaultborder/30 dark:bg-bodybg"
