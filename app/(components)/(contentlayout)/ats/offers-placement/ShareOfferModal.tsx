...
export default function ShareOfferModal({ offer, onClose, onSent }: ShareOfferModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[120] flex items-center justify-center bg-black/40 p-4">
      <div className="w-full max-w-lg rounded-lg bg-white p-5 shadow-xl dark:bg-bodybg">
        ...
        <div className="flex justify-end gap-2">
          <button type="button" className="ti-btn ti-btn-light" onClick={onClose} disabled={submitting}>
            Cancel
          </button>
